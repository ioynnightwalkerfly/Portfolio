...
const songs = [
  "song-list/Hiding_In_The_Blue.mp3",
  "song-list/Scars_To_Your_Beautiful.mp3",
  "song-list/That_Girl.mp3",
  "song-list/Love_Me_Harder.mp3",
  "song-list/Bumpy_Ride.mp3",
  "song-list/Thats_So_True.mp3",
];
